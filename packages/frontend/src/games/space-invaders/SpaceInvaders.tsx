...
import styles from './SpaceInvaders.module.scss';
...
export function SpaceInvaders() {
  ...
  const submitMutation = useMutation({
    mutationFn: (payload: { score: number; elapsedMs: number }) => api.post<ScoreResponse>('/games/space-invaders/scores', payload),
  });
      ...
      <div className={styles.screenWrap}>
        ...
        {status !== 'playing' && (
          <div className={styles.overlay}>
            {status === 'ready' && (
              <>
                <p>Arrow keys / A-D to move, Space to fire.</p>
